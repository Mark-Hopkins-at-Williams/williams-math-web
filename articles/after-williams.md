...
Students interested in continuing their study of mathematics in graduate school should consider: MATH 140, MATH 150 or 151, MATH 250, MATH 350, MATH 355, Complex Analysis, Topology, some second-semester analysis, some second-semester algebra, some post-core geometry, and a thesis. (With prior permission, in unusual circumstances, the senior seminar can be waived in favor of harder post-core electives.) Students headed for graduate school generally take more than the relatively small number of courses required for a liberal arts major.

Students interested in studying statistics in graduate school should take STAT 201, 346, 360, a 400-level statistics course, and MATH 350/351 and 341 in addition to their other math requirements.
...
**Statistics and actuarial science:** Consider MATH 341, statistics courses, and ECON 255. Students should also consider taking some of the actuarial exams given by the Society of Actuaries, which can constitute part of an honors program in actuarial studies.

**Teaching:** Students interested in teaching mathematics at the elementary or secondary school level should consider courses on teaching, number theory, geometry, statistics, and practice as a tutor or teaching assistant. Winter study courses that provide a teaching practicum are also highly recommended.
...
- **Jules Walzer-Goldfeld:** English Language Teacher through the Education Office of Spain
